...
from utils.augmentations import Albumentations, augment_hsv, copy_paste, letterbox, mixup, cutmix, random_perspective
...
class LoadImagesAndLabels(Dataset):  # for training/testing
    ...
    def __getitem__(self, index):
        ...
        if mosaic:
            ...
            # CutMix augmentation https://arxiv.org/pdf/1905.04899v2.pdf
            if random.random() < hyp['cutmix']:
