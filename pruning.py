...
if __name__ == '__main__':
    ...
    parser.add_argument('--weights', default="./weights/0.01_IMP/2nd/sl_epoch53.pt",type=str, help='')
    parser.add_argument('--save_path', default="./weights/0.01_IMP/2nd", type=str, help='')
